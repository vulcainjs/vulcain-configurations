import { IScopedComponent, Query, IRequestContext, Property, Model, IContainer, Inject, DefaultServiceNames, System, QueryHandler, ApplicationError } from 'vulcain-corejs';
